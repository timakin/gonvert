...
var definiteTestData = []struct {
	...
	{UTF16LE, UTF8, "S0\x8c0o0\"oW[g0Y0\x020", "これは漢字です。"},
	{UTF8, UTF16LE, "これは漢字です。", "S0\x8c0o0\"oW[g0Y0\x020"},
	{UTF16BE, UTF8, "0S0\x8c0oo\"[W0g0Y0\x02", "これは漢字です。"},
	{UTF8, UTF16BE, "これは漢字です。", "0S0\x8c0oo\"[W0g0Y0\x02"},
}
